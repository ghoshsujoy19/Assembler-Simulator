	...
	if request.method == "POST":
		...
		for file in fileNames:
			...
			with open(file+'.pass1') as f:
				pass1[file] = f.read()
				totalSize = totalSize + len(pass1[file].split('\n'))
		...
		print(symTable)
	return json.dumps({'status':'OK' ,'tot':totalSize, 'pass1':pass1, 'pass2':pass2, 'lin':lin, 'symTable':symTable, 'globTable':globTable, 'extTable':extTable , 'ifTable': iftable, 'filedata':filedata, 'litTable':litTable})
